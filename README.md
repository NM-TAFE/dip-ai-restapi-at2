# AT2 Build MCP Server Starter Repo

This repository is lecturer-provided starter scaffolding for the AT2 MCP Server assessment.
It includes class-session examples showing how to build and test an MCP server with tools, resources, prompts, STDIO transport, and Streamable HTTP transport.

## Starter Repo Purpose
...
- the sample unit-converter context with their own assessment context
- the example tools in `mcp_tools/`
